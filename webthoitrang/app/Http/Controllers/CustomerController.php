...
// xác thực đăng nhập
    ...
    public function vieworder_customer($customer_name){
        ...
        return view('pages.vieworder_customer')->with('category', $cate_product)->with('brand', $brand_product)->with(compact('manage_order'));
    }
    ...
    public function viewdetails_order_customer($order_code){
        ...
        return view('pages.viewdetails_order_customer')->with('category', $cate_product)->with('brand', $brand_product)->with(compact('manage_details_order'));
    }
