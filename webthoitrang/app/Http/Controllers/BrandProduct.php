...
class BrandProduct extends Controller
{
    ...
    // hiển thị giao diện thêm thương hiệu
    ...
    //hiển thị giao diện chỉnh sửa thương hiệu sản phẩm
    ...
    // hiển thị sản phẩm theo thương hiệu bên giao diện bán hàng
